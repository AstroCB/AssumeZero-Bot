...
exports.commands = {
    ...
    "spotsearch": {
        "display_names": ["spotify search", "spotify search artist", "spotify search song", "spotify search track"],
        ...
        "syntax": "spotify search (artist|(song|track)) ${query}",
        "sudo": false,
        "user_input": {
            "accepts": false,
            "optional": false
        },
        "regex": /spotify search (artist|song|track) (.*)/i,
        "experimental": false
    },
    "photo": {
